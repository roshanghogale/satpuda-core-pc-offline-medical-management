...
class PurchaseHistoryPage:
    ...
    def load_purchase_history(self):
        ...
        try:
            ...
            self.purchase_data = []
            messagebox.showerror("Database Error", "Failed to load purchase history.")
    ...
    def _export_current_view(self):
        ...
        if not rows:
            messagebox.showinfo("No Records", "No data visible.")
            return
    ...
    def _export_purchase_register(self):
        ...
        if not rows:
            messagebox.showinfo("No Records", "No purchases found.")
            return
    ...
    def _export_supplier_due(self):
        ...
        rows = self.cursor.fetchall()
        if not rows:
            messagebox.showinfo("No Records", "No outstanding dues.")
            return
    ...
    def _export_gst_purchase(self):
        ...
        rows = self.cursor.fetchall()
        if not rows:
            messagebox.showinfo("No Records", "No items found.")
            return
